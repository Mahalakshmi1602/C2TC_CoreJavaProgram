...
public class LevelOneEmployee extends Employee {
	    ...
	    public LevelOneEmployee(String name, long contactNo, Date dob,String deptName, double baseSalary, int noOfShares, String authority) {
	    	super(name,contactNo,dob,deptName, baseSalary);
